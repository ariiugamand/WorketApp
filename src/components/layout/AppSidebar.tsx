...
import {
  LayoutDashboard, Users, Calendar, CalendarDays, ClipboardList, FileText, LogOut, ChevronLeft, ChevronRight, Leaf
} from "lucide-react";
...
const navItems = [
  ...
  { title: "Мероприятия", url: "/events", icon: CalendarDays },
      ...
      <div className="flex items-center gap-3 px-4 h-16 border-b border-sidebar-border">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            <p className="text-sidebar-accent-foreground font-bold text-sm leading-none">Кадровая</p>
            <p className="text-sidebar-muted text-xs">система</p>
          </div>
        )}
      </div>
